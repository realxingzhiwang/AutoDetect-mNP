...
m = m'; %The reshape function not only reshape the matrix but flips the image, so would have to transpose that to maintain the correct orientation of the image
