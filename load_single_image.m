...
%imshow(uint8(m/256))
%%
[image_test, image_bw_test, features_test, particles_all_test, unit_test, particles_org_test, moments_test, centroids_test] = loadEMimages(fullfile(path_test, file_test),@loadtiff,@identity);
